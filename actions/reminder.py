...
def reminder(
    ...
    # Support relative timer: "N minutes from now"
    if minutes is not None:
        try:
            target_dt = datetime.now() + timedelta(minutes=int(minutes))
        ...
        return "I need either a date+time, or a number of minutes from now."
