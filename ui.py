...
class SetupOverlay(QWidget):
    ...
    def __init__(self, parent=None, initial: dict | None = None, mode: str = "init"):
        ...
        self._test_btn.setStyleSheet(f"""
            ...
            QPushButton:hover {{
                background: {C.PRI_GHO}; border: 1px solid {C.ACC2};
            }}
    ...
    def _test_connection(self):
        ...
        self._test_status.setStyleSheet(f"color: {C.ACC2}; background: transparent;")
    ...
    def _do_test(self):
        ...
        self._test_status.setStyleSheet(
            f"color: {C.GREEN if is_ok else C.RED}; background: transparent;"
        )
...
class MainWindow(QMainWindow):
    ...
    def _build_right_panel(self) -> QWidget:
        ...
        self._island_btn = QPushButton("◈  DYNAMIC ISLAND")
        self._island_btn.setFixedHeight(26)
        self._island_btn.setFont(QFont("Courier New", 7))
        ...
        """)
        self._island_btn.clicked.connect(self._toggle_island)
    ...
    def _build_footer(self) -> QWidget:
        ...
        lay.addWidget(_fl("[F4] Mute  ·  [F11] Fullscreen  ·  [F12] Dynamic Island"))
        lay.addStretch()
